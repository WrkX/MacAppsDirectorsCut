...
*  [Cotypist](https://cotypist.app/) (**Free**): If you dont know this, it uses a local LLM to help you with text prediction, like, everywhere. Tab accepts the next word or you continue typing and maybe it starts to pickup whatever you write on your way. I takes screenshots and starts to learn what you do, how you write etc. Basically like Windows Recall, just that the data is stored locally. My old text from like 3 weeks ago was this:
  > Still on the fence about this. It should improve writing, by using a local running AI model and use whatever you opened/copied etc. to give suggestions when writing. Basically like Windows Recall, just that the data is stored locally. So far, the text suggestions were mediocre, but I continue as long as its free. Uses ~500MB of RAM, so its fine...

But now, after I have used it for quite some time and after a few updates it became really really awesome. It constantly knows what I want to write and I just keep tabbing. Awesome. Currently free, dunno what the future brings.
...
*  [OwlOCR](https://apps.apple.com/us/app/owlocr/id6462355119) (**Free** or *Subscription* or *Paid*): Just a great OCR tool. It works great. There is an optional Pro subscription, but i dont know what it does tbh. But you can also buy for a lifetime, so even better (still dunno what it does tho).

*  [SourceGit](https://sourcegit-scm.github.io/) (**Free, open source**): A free and open source git client. Great for bigger projects.

*  [Thaw](https://github.com/stonerl/Thaw) (**Free, open source**): I always used (and still use) Barbee, but this became a great alternative for me. Barbee uses more RAM, but in Thaw my icons randomly change into other categories (like from hidden to shown etc). Thaw is a Ice fork, that works better. So Menu Bar cleanup that also works on Tahoe. Lovely. 

* [Zed](https://zed.dev/): (**Free, open source**, *Subscription for AI*): An IDE. Looks great, works great, prefer it over VSCode, except for its shitty Git integration. If the git wouldnt be this bad, I would get rid of VS Code. Yes, yes I just mentioned SourceGit before, but i have some very small repos, for like Steam deck plugins etc. and I am to lazy to open a git gui just to check in a few things. Yes, Zed would be find for that, but you cannot commmit ranges. If you have edits in line 20-40, you can only commit that whole block. Sounds nitpicky, I know, but i use that a lot.

* [Blip](https://blip.net/download) (**Free**): Airdrop, just without having to be near the other person, and cross platform (except Linux, big f for now, please sign up for linux on their website <3). I mention this as free, since it is free unless you are a business.

* [Omni Content Hub](https://apps.apple.com/de/app/omni-content-hub/id6741470807?l=en-GB) (*Paid*): A content hub, similar to e.g. the app that start with Strem and with io, also works with its addons. Almost no updates and on Mac it is just the IPad app, but it works wonderfully. I use it on my Apple TV and while it has problems, I prefer it over all alternatives. Also dont wanna move my catalogs, so I am kinda stuck.

* [WireGuard](https://apps.apple.com/de/app/wireguard/id1451685025?l=en-GB&mt=12) (**Free**): Just a replacement for Tailscale, since it works better. Private Network for all my devices, so I can reach my homenetwork from hotels etc. I was able to set up my router as my WireGuard Server, so it is super easy.

</br>

# Noteworthy updates to apps

* [Alcove](https://tryalcove.com/) (*Paid*): The Dev is continuely working on it. Like, every day (almost). Great app!
  
* [Dia](https://www.diabrowser.com/) (**Free** or *Subscription*): As i said above. The tabs were improved and the Browser is fine. Still not on Arc levels, but they are getting there i guess. Also, they are removing their subscription again? Dunno what is gonna happen, maybe a new browser /s

* [1Password](https://1password.com/pricing?currency=eur) (*Subscription*): Not really an update to their app, but they increased their subscription price. Doesnt change how I feel about them, best Password Manager I found.

</br>

# Apps I have tried that did not stay

* [Cmux](cmux.com) (**Free, open source**): Terminal with vertical tabs (workspaces) and a lot of features. Sounds great, but I didnt need it. So i continue to use Ghostty.

* [Typewhisper](https://www.typewhisper.com/en/) (**Free, open source**): Another Voice to text app. I still prefer Spokenly. I had a few problems with TypeWhisper (has been some time, so I dont remember exactly) but Spokenly does all the things I need.

* [Eagle](https://eagle.cool/) (*Paid*): I dont see any reason to use this over... like... a folder on my desktop + a shortcut that quickly saves there. I just tested it, didnt pay, so I am good.

* [Fusion](https://apps.apple.com/de/app/fusion-media-center/id6759285919?l=en-GB) (**Free**): Another Content Hub, similar to [Omni Content Hub](https://apps.apple.com/de/app/omni-content-hub/id6741470807?l=en-GB), but it is completely free. I prefer Omni tho.
...
I swapped to ICloud. Koofr became more of a longterm storage since i have a lifetime storage plan.
...
Did not really need it. Works fine without.
...
Replaced it with [SourceGit](https://sourcegit-scm.github.io/), but most of the time VSCode or Zed's integrated Git works fine.
...
I just moved to [WireGuard](https://apps.apple.com/de/app/wireguard/id1451685025?l=en-GB&mt=12). Everything i needed from Tailscale works better with Wireguard (for me). Don't need most of the features and my router is my WireGuard server.
...
Currently I use Instapaper. I explained in the Instapaper section why I use it.
...
Not needed anymore. I am not trying out all to many apps, and I use the [Topgrade](https://github.com/topgrade-rs/topgrade) command to update my things + Latest](https://max.codes/latest/) for stuff topgrade doesnt update.
...
MacOS now allows this natively without having to spend money.
...
Bad. Like, I removed it long time ago. It was renamed to THOHT, but that wont improve it. It uses an old AI model, even the "Demo" on the website shows how slow it is. Compared to Spokenly + parakeet, its crazy that the dev continues with whatever he is using here.
...
Both of them were replaced by [Brave Browser](https://brave.com/de/) and [Dia](https://www.diabrowser.com/). I just prefer them.
