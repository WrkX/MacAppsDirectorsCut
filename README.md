...
* [AltTab](https://github.com/lwouis/alt-tab-macos) (**Freemium, open source**): I guess almost everyone uses this? Almost perfect window switcher. If [Contexts](https://contexts.co/) would still get updates I would use it, but the “Titles” Appearance option is great here, too. Only thing bothering me is that titles scale to the monitor width with no way to change it? Maybe I will fork it and fix it for myself. Sadly, it has a pro version that is basically needed now. The Dev took away what we already had and sells it now... I understand that dev time is not free, but that was in my opinion, the worst way to go about it.
...
* **!**[Otty](https://otty.sh/) (**Free**): A Terminal from the creators of Typora. It's a beautiful terminal, super customizable, has everything i want. Kinda like Warp, just not as bloated. I am pretty sure it's based on libghostty but who know for sure.
