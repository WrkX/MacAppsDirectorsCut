...
* **!!** [WireGuard](https://apps.apple.com/de/app/wireguard/id1451685025?l=en-GB&mt=12) (**Free**): Just a replacement for Tailscale, since it works better. Private Network for all my devices, so I can reach my homenetwork from hotels etc. I was able to set up my router as my WireGuard Server, so it is super easy. Not only for Gaming, also for like Grimmory, selfhosted Gitlab etc., but Tailscale was placed here, so I am gonna put WireGuard here, too.
...
* <del>[Cotypist](https://motherfuckingwebsite.com/) (**Free**): If you dont know this, it uses a local LLM to help you with text prediction, like, everywhere. Tab accepts the next word or you continue typing and maybe it starts to pickup whatever you write on your way. I takes screenshots and starts to learn what you do, how you write etc. Basically like Windows Recall, just that the data is stored locally. My old text from like 3 weeks ago was this: Still on the fence about this. It should improve writing, by using a local running AI model and use whatever you opened/copied etc. to give suggestions when writing. Basically like Windows Recall, just that the data is stored locally. So far, the text suggestions were mediocre, but I continue as long as its free. Uses ~500MB of RAM, so its fine...</del> **EMERGENCY: F*ck this app and everyone involved. It starts to become usable and bam 10$ month subscription for an app using a local model. Nonono guys, better dictate what you wanna write and use** [Spokenly](https://spokenly.app/)
